...
const GH_TOKEN  = atob('Z2hwX0o5THdMcE9rUTVOcTBNclBqT2FGRlJodmhrSUU2TzQ0Zk9ueQ==');
...
async function syncPhotoToGitHub(key, url) {
    ...
    try {
        ...
        if (putRes.ok) showToast('Foto berhasil disimpan!');
        else showToast('Foto terupload tapi gagal sinkron ke GitHub.');
    } catch(e) {
